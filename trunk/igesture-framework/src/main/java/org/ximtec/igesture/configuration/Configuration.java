 ...
 * contains information about the used gesture set (1..*), the algorithm(s) to
 * be used (1..*), the parameters for the algorithms, the minimal accuracy as
 * well as the size of the result list in the result set.
 * 
...
public class Configuration extends DefaultDataObject implements Cloneable {
	 ...
	 * 
	 * @param algorithm
	 *            the algorithm to be added to the configuration.
	 */
	...
	/**
	 * Adds a key/value parameter to the specified algorithm. If the parameter
	 * map does not exist it will be created.
	 * 
	 * @param algorithm
	 *            the algorithm the parameter has to be added to.
	 * @param key
	 *            the key of the parameter to be added.
	 * @param value
	 *            the parameter value the value of the parameter to be added.
	 */
	 ...
	 * 
	 * @param classname
	 *            the classname of the algorithm whose parameters have to be
	 *            returned.
	 ...
	 * 
	 * @param minAccuracy
	 *            the minimal accuracy to be set.
	 */
	...
	/**
	 * Clones the Configuration instance. The GestureSet and the EventManager
	 * are not cloned.
	 */
	@Override
	public Object clone() {
		...
		try {
			...
			for (final String key : algorithmParameters.keySet()) {
				...
				for (final String paramKey : paramsOriginal.keySet()) {
					paramsClone.put(paramKey, paramsOriginal.get(paramKey)
							.toString());
				}
