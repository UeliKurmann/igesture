...
public class InputDeviceFactory {
	 ...
	 * @return
	 */
	private static String getParameter(XMLConfiguration configuration, String deviceIdentifier, String parameterName){
		List list = configuration.getList(getParameterXPathString(deviceIdentifier, parameterName));		
		if(!list.isEmpty()){
