...
public class ResultSet {
	...
	/**
	 * Adds a result object to the result set. The result set is always ordered
	 * by the accuracy value of the result objects.
	 * 
	 * @param result
	 *            the result object to be added.
	 */
	...
	public List<Result> getResults() {
		return new ArrayList<Result>(results).subList(0, Math.min(maxSize,
				results.size()));
	} // getResults
	 ...
	 * 
	 * @param index
	 *            the index of the result object to be returned.
	 ...
	 * 
	 * @return the first result object or null if the result set does not
	 *         contain any result obejcts.
	 */
	 ...
	 * 
	 * @param gestureClass
	 *            the gesture class to be tested.
	 ...
	 * 
	 * @param note
	 *            the note containing the gesture.
	 */
