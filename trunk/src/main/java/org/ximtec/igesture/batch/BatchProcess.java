...
public class BatchProcess {
    ...
    * 
    * @param sets the gesture set to be added
    */
   ...
   public BatchResultSet run() {
      ...
      for (final Configuration config : configurations) {
         ...
         try {
            ...
            for (final GestureSample sample : testSet.getSamples()) {
               ...
               if (resultSet.isEmpty()) {
                  ...
                  if (resultSet.getResult().getName().equals(sample.getName())) {
         ...
         System.out
               .println((double) counter / configurations.size() * 100 + "%");
         counter++;
      }
    ...
    * @param index the index of the parameter (ith Parameter)
