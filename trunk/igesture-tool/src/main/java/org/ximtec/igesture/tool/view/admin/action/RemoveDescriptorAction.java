...
public class RemoveDescriptorAction extends BasicAction{
  ...
  public RemoveDescriptorAction(TreePath treePath){
    super(GestureConstants.DESCRIPTOR_DEL, Locator.getDefault().getService(GuiBundleService.IDENTIFIER, GuiBundleService.class));
  ...
  public void actionPerformed(ActionEvent arg0) {
    ...
    GestureClass gestureClass = (GestureClass)treePath.getParentPath().getLastPathComponent();
