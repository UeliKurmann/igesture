 ...
 *
 */
public class MoveGestureClassAction extends TreePathAction {

	public MoveGestureClassAction(Controller controller, TreePath treePath) {
		super(GestureConstants.GESTURE_CLASS_MOVE, controller, treePath);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ((choice != null) && (choice.length() > 0)) {
			...
			//remove the gesture from the current gesture set
			currentGestureSet.removeGestureClass(gestureClass);
			//and add it to the selected set
