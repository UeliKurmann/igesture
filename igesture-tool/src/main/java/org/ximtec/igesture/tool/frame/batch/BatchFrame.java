...
public class BatchFrame extends BasicInternalFrame implements
   ...
   private void init() {
      ...
      JButton configButton = SwingTool.createButton(new ActionSelectConfigFile(
            configPath));
      ...
      JButton outputButton = SwingTool.createButton(new ActionSelectResultFile(
            outputPath));
