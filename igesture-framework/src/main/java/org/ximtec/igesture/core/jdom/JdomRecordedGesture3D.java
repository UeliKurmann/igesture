...
public class JdomRecordedGesture3D extends Element {
   ...
   public JdomRecordedGesture3D(RecordedGesture3D gesture) {
      ...
      addContent(new JdomWiiAccelerations(gesture.getAccelerations()));
   }
   ...
   public static RecordedGesture3D unmarshal(Element gesture) {
      ...
      Element acc = gesture.getChild(JdomWiiAccelerations.ROOT_TAG);
      newGesture.setAccelerations(JdomWiiAccelerations.unmarshal(acc));
