...
public class AlgorithmFactory {
	 ...
	 *             if the algorithms could not be created.
	 */
	 ...
	 * 
	 * @param file
	 *            the XML file with the configuration.
	 * @return the initialised algorithm.
	 * @throws AlgorithmException
	 *             if the algorithm could not be created.
	 */
	public static Algorithm createAlgorithm(File file)
			throws AlgorithmException {
	 ...
	 *            the XML file that contains the configuration.
	 * @param set
	 *            the XML file with the gesture set.
	 * @return the initialised algorithm.
	 * @throws AlgorithmException
	 *             if the algorithm could not be created.
	 */
	 ...
	 * 
	 * @param className
	 *            the full qualified name of the algorithm.
